...
//!!!!!!!!!!end
    ...
    {
        o+=' <div class="row ';//beg div row
        if("已结束"===t.matchPeriod)
        {
            if(t.leftGoal-0>t.rightGoal-0){o+='left-win ';}
            else if(t.leftGoal-0<t.rightGoal-0){o+='right-win ';}
        }
        o+=s(e%2===0?"odd":"even")+'" data-mid="'+s(t.mid)+'"> ';//end div row def
        
            o+=' <div class="time" data-mid="'+s(t.mid)+'"> ';//beg div time
            o+=s(t.startTime)+" ";
            if("1"===t.isPay){o+='<span class="vip">会员</span>';}
            o+='</div>';//end div time
        
            o+='<div class="status">';//beg div status
            o+=s("直播中"===t.matchPeriod?t.quarter:t.matchPeriod),
            o+="</div> ";//end div status
...
o+=" "),
    ...
    define(
        "dataCtrl",
        ["jquery","promise","moment","config.data"],
        function(t,e,a,i){
            var n,s,o=!1,
                r=function(e,a,i,n)
                {
                ...
                l=function(t,e,a,i,n)
                {
                    ...
                    i/=1;
                    var s;
                    return n===t?(s=e,s>i?"\u80dc":"\u8d1f"):(s=i,s>e?"\u80dc":"\u8d1f");
                },
                d=function(t)
                {
                    var e="http://sportswebapi.qq.com/kbs/calendar?from=NBA_PC&columnId=100000";
                    n?t(n):r(e,function(e)
                        {
                            if(0!==e.code){throw o=!1,new Error("calendar's interface exception.");}
                            if(a("2016-10-02").isAfter(a(e.data.today))){e.data.today="2016-10-02";}
                            n=e.data,t(n),o=!1;
                        },function(){})
                },
                f=function(a,i,l)
...
r(n,function(a){if(0!==a.code)throw e(),new Error("calendar's interface exception.");t(a.data)},
  function(t){e()})});e.all([d,f]).then(function(e){var a=e[0],i=e[1],
    s=function(t)
    {
        switch(t){
...
r=[];
            t.each(i,function(e,i)
            {
                ...
                {var r=a[n];"startTime"===r?i[r]=e[r].split(" ")[1].replace(/(\:\d{2})$/g,""):"matchPeriod"===r?i[r]="0"===e[r]?"未开始":"1"===e[r]?"直播中":"\u5df2\u7ed3\u675f":"latestNews"===r?e[r]&&(i[r]=e[r]):"week"===r?i[r]=s(e[r]):/EnName/g.test(r)?i[r]=c(e[r]):i[r]=e[r]}
                            ...
                            l.push(i)});
                var f=e.split("-");l.length>0?o.date=f[1]+"\u6708"+f[2]+"\u65e5 "+l[l.length-1].week:o.date=f[1]+"\u6708"+f[2]+"\u65e5",e===n.today&&(o.date=o.date+"\uff08\u4eca\u5929\uff09"),o.data=l,r.push(o)
            }),
                o=!1,
                l(r)
    })
                ...
                m=function(e,a){
    var n = "http://mat1.gtimg.com/apps/hpage2/nbateammatchlist_" + e + ".json",
    s = ["startTime", "isPay", "leftId", "leftBadge", "leftName", "leftEnName", "leftGoal", "rightId", "rightGoal", "rightName", "rightEnName", "rightBadge", "matchPeriod", "matchType", "mid", "liveType", "latestNews", "coverCollection", "coverPlayback"];
r(n, function (n) {
    var r = [];
    t.each(n, function (a, n) {
        if (parseInt(a.split("-").join("")) >= i.range[0].replace("-", "").substring(0, 6) - 0) {
            var o = {};
            o.date = a.replace(/^(\d{4}\-)/g, "") + "\u6708",
                o.data = [],
